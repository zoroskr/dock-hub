  ...
  return (
    <div className="max-w-sm bg-custom-gray rounded-xl shadow dark:bg-gray-800 dark:border-gray-700 duration-500 hover:scale-105">
      ...
      <div className="p-5 flex flex-wrap justify-between">
        ...
        { showProposeButton ? (
          <button onClick={handleSubmit} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-gray-800 rounded-xl duration-300 hover:bg-gray-700">
          ...
          <svg className="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
            ...
            <div className="flex flex-col gap-2">
              <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-xl duration-300 hover:scale-105">
                Eliminar Publicación
              </a>
              <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-800 rounded-xl duration-300 hover:scale-105">
                Editar Publicación
              </a>
              <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-yellow-800 rounded-xl duration-300 hover:scale-105">
                Pausar Publicación
              </a>
            </div>
          )
